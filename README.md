...
> Scrobblea tu música a Last.fm, actualiza el estado de "Ahora Reproduciendo" y love/ban canciones directamente desde Jellyfin.

## Características

- **Scrobbling Automático**: Las canciones se scrobblean a Last.fm al alcanzar el 25% de reproducción o 4 minutos, lo que ocurra primero
- **Notificaciones Ahora Reproduciendo**: Actualiza tu perfil de Last.fm con lo que estás escuchando actualmente
- **Love/Ban Canciones**: Marca canciones como favoritas o prohibidas en Last.fm a través de la API del plugin
- **Auto-Love**: Opcionalmente, marca como favoritas automáticamente las canciones que tienes como favoritas en Jellyfin
- **Configurable**: Ajusta el porcentaje de scrobble, duración mínima y origen del artista
- **Multi-Usuario**: Soporta múltiples sesiones de Jellyfin simultáneamente

## Requisitos

- Jellyfin 10.11.x o superior
- Cuenta de API de Last.fm (gratis)
...
Crea un archivo `nuget.config` en la raíz del repositorio:
